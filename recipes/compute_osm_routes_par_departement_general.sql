...
SELECT the_geom, num_route_com_id, "INSEE_COM", num_route_or_id, cat_route_osm
...
SELECT ST_UNION(the_geom::geometry) as the_geom, 'Boulevard Périphérique75' as num_route_com_id, '75056' as "INSEE_COM", 'Boulevard Périphérique' as num_route_or_id, 'route principale' as cat_route_osm
  FROM "osm_routes_par_departement"
