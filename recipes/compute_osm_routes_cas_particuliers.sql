SELECT ST_UNION(the_geom::geometry)::geography as the_geom, 'Boulevard Périphérique75' as num_route_com_id, '75056' as "INSEE_COM", 'Boulevard Périphérique' as num_route_or_id, 'route principale' as cat_route_osm
